...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            recipe.AddStep(recipe.CreateStep(GetProduct("Café"), 100, GetEquipment("Cafetera"), 120));
            recipe.AddStep(recipe.CreateStep(GetProduct("Leche"), 200, GetEquipment("Hervidor"), 60));
